...
And there you go, the report is ready to knit to HTML.  I usually use RStudio's *Knit* button but you can do it from the command line as well: `knitr::knit("your_filename.Rmd", "your_filename.html")`  
