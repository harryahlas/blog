...
This post is a follow-up to my earlier post, [Use R to add a Data Disclaimer to an Excel Report](http://harry.ahlas.com/2019/04/07/information-security-tab/index.html) **NEEDS EDIT-------------**. In that post, we created a single enterprise-wide human resources report along with a data disclaimer.
