...
library(lubridate)
```
We will start by installing the ficticious *hrsample* HR database ([hrsample blog](/post/the-hrsample-package-and-database/)). If you went through my earlier blog entry, [Multi-Condition Data Retrieval](/post/multi-condition-data-retrieval/), you can continue to use that same database and skip this next step.
